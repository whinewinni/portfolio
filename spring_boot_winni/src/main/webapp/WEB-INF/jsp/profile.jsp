...
<html lang="ko">
	...
	<body>
		...
		<div id="profile" class="container-fluid" style="border: 1px solid red; width:50vw; margin: 10% auto;">
			<div class="row">
				<div id="selfie" class="col-sm-4" style="background-color:lavenderblus">
					<img alt="" src="img/aboutme/selfie01.png">
				</div>
				<div id="profile_detail" class="col-sm-8" style="background-color:lavender"> 
					<h2>Winni CHO</h2>
					<small>
