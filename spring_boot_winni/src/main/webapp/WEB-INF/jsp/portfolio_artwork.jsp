...
<html lang="ko">
	...
	<body>  
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="img/pofol/art_work01_thum.png">
						</div>
						<div class="carousel-item">
							<img src="img/pofol/art_work02_thum.png">
						</div>
						<div class="carousel-item">
							<img src="img/pofol/art_work03_thum.png">
						</div>
						<div class="carousel-item ">
							<img src="img/pofol/art_work04_thum.png">
						</div>
						<div class="carousel-item">
							<img src="img/pofol/art_work05_thum.png">
						</div>
						<div class="carousel-item">
							<img src="img/pofol/art_work06_thum.png">
						</div>
						<div class="carousel-item">
							<img src="img/pofol/art_work07_thum.png">
						</div>
					</div>
		...
		<div id="mobile">
			...
			<div id="mobile_left">
				<div class="card">
					<img src="img/pofol/m01.png" class="card-img-top" alt="...">
					<div class="card-body">
			...
			<div id="mobile_right">
				<div class="card">
					<img src="img/pofol/m02.png" class="card-img-top" alt="...">
					<div class="card-body">
						<h5 class="card-title">Card title</h5>
						<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						<a href="#" class="btn btn-primary">Go somewhere</a>
